...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EconomicResourceType.materiality'
        db.delete_column('valueaccounting_economicresourcetype', 'materiality')


    def backwards(self, orm):
        # Adding field 'EconomicResourceType.materiality'
        db.add_column('valueaccounting_economicresourcetype', 'materiality',
                      self.gf('django.db.models.fields.CharField')(default='intellectual', max_length=12),
                      keep_default=False)
