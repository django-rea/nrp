...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EconomicResourceType.subclass'
        db.add_column('valueaccounting_economicresourcetype', 'subclass',
                      self.gf('django.db.models.fields.CharField')(default='other', max_length=12),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EconomicResourceType.subclass'
        db.delete_column('valueaccounting_economicresourcetype', 'subclass')
