...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('valueaccounting_order', 'order_type',
                      self.gf('django.db.models.fields.CharField')(default='customer', max_length=12),
                      keep_default=False)

        # Adding field 'Order.created_by'
        db.add_column('valueaccounting_order', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='orders_created', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Order.changed_by'
        db.add_column('valueaccounting_order', 'changed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='orders_changed', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Option.created_by'
        db.add_column('valueaccounting_option', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='options_created', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Option.changed_by'
        db.add_column('valueaccounting_option', 'changed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='options_changed', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Process.created_by'
        db.add_column('valueaccounting_process', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='processes_created', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Process.changed_by'
        db.add_column('valueaccounting_process', 'changed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='processes_changed', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'ProcessType.created_by'
        db.add_column('valueaccounting_processtype', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='process_types_created', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'ProcessType.changed_by'
        db.add_column('valueaccounting_processtype', 'changed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='process_types_changed', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'AgentResourceType.created_by'
        db.add_column('valueaccounting_agentresourcetype', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='arts_created', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'AgentResourceType.changed_by'
        db.add_column('valueaccounting_agentresourcetype', 'changed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='arts_changed', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Project.created_by'
        db.add_column('valueaccounting_project', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='projects_created', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Project.changed_by'
        db.add_column('valueaccounting_project', 'changed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='projects_changed', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Feature.created_by'
        db.add_column('valueaccounting_feature', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='features_created', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Feature.changed_by'
        db.add_column('valueaccounting_feature', 'changed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='features_changed', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'EconomicResource.created_by'
        db.add_column('valueaccounting_economicresource', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='resources_created', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'EconomicResource.changed_by'
        db.add_column('valueaccounting_economicresource', 'changed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='resources_changed', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'ProcessTypeResourceType.created_by'
        db.add_column('valueaccounting_processtyperesourcetype', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ptrts_created', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'ProcessTypeResourceType.changed_by'
        db.add_column('valueaccounting_processtyperesourcetype', 'changed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ptrts_changed', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.order_type'
        db.delete_column('valueaccounting_order', 'order_type')

        # Deleting field 'Order.created_by'
        db.delete_column('valueaccounting_order', 'created_by_id')

        # Deleting field 'Order.changed_by'
        db.delete_column('valueaccounting_order', 'changed_by_id')

        # Deleting field 'Option.created_by'
        db.delete_column('valueaccounting_option', 'created_by_id')

        # Deleting field 'Option.changed_by'
        db.delete_column('valueaccounting_option', 'changed_by_id')

        # Deleting field 'Process.created_by'
        db.delete_column('valueaccounting_process', 'created_by_id')

        # Deleting field 'Process.changed_by'
        db.delete_column('valueaccounting_process', 'changed_by_id')

        # Deleting field 'ProcessType.created_by'
        db.delete_column('valueaccounting_processtype', 'created_by_id')

        # Deleting field 'ProcessType.changed_by'
        db.delete_column('valueaccounting_processtype', 'changed_by_id')

        # Deleting field 'AgentResourceType.created_by'
        db.delete_column('valueaccounting_agentresourcetype', 'created_by_id')

        # Deleting field 'AgentResourceType.changed_by'
        db.delete_column('valueaccounting_agentresourcetype', 'changed_by_id')

        # Deleting field 'Project.created_by'
        db.delete_column('valueaccounting_project', 'created_by_id')

        # Deleting field 'Project.changed_by'
        db.delete_column('valueaccounting_project', 'changed_by_id')

        # Deleting field 'Feature.created_by'
        db.delete_column('valueaccounting_feature', 'created_by_id')

        # Deleting field 'Feature.changed_by'
        db.delete_column('valueaccounting_feature', 'changed_by_id')

        # Deleting field 'EconomicResource.created_by'
        db.delete_column('valueaccounting_economicresource', 'created_by_id')

        # Deleting field 'EconomicResource.changed_by'
        db.delete_column('valueaccounting_economicresource', 'changed_by_id')

        # Deleting field 'ProcessTypeResourceType.created_by'
        db.delete_column('valueaccounting_processtyperesourcetype', 'created_by_id')

        # Deleting field 'ProcessTypeResourceType.changed_by'
        db.delete_column('valueaccounting_processtyperesourcetype', 'changed_by_id')
    ...
    models = {
        ...
        'valueaccounting.agentresourcetype': {
            ...
            'relationship': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'agent_resource_types'", 'to': "orm['valueaccounting.ResourceRelationship']"}),
        ...
        'valueaccounting.commitment': {
            ...
            'relationship': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'commitments'", 'to': "orm['valueaccounting.ResourceRelationship']"}),
        ...
        'valueaccounting.feature': {
            ...
            'relationship': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'features'", 'to': "orm['valueaccounting.ResourceRelationship']"}),
        ...
        'valueaccounting.processtyperesourcetype': {
            ...
            'quantity': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '8', 'decimal_places': '2'}),
            'relationship': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'process_resource_types'", 'to': "orm['valueaccounting.ResourceRelationship']"}),
