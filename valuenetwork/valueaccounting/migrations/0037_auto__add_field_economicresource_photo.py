...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EconomicResource.photo'
        db.add_column('valueaccounting_economicresource', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EconomicResource.photo'
        db.delete_column('valueaccounting_economicresource', 'photo')
