...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EconomicResource.author'
        db.add_column('valueaccounting_economicresource', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='authored_resources', null=True, to=orm['valueaccounting.EconomicAgent']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EconomicResource.author'
        db.delete_column('valueaccounting_economicresource', 'author_id')
