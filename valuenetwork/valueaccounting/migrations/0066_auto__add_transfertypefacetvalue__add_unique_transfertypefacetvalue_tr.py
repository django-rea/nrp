...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TransferTypeFacetValue'
        db.create_table('valueaccounting_transfertypefacetvalue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('transfer_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='facet_values', to=orm['valueaccounting.TransferType'])),
            ('facet_value', self.gf('django.db.models.fields.related.ForeignKey')(related_name='transfer_types', to=orm['valueaccounting.FacetValue'])),
        ))
        db.send_create_signal('valueaccounting', ['TransferTypeFacetValue'])

        # Adding unique constraint on 'TransferTypeFacetValue', fields ['transfer_type', 'facet_value']
        db.create_unique('valueaccounting_transfertypefacetvalue', ['transfer_type_id', 'facet_value_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'TransferTypeFacetValue', fields ['transfer_type', 'facet_value']
        db.delete_unique('valueaccounting_transfertypefacetvalue', ['transfer_type_id', 'facet_value_id'])

        # Deleting model 'TransferTypeFacetValue'
        db.delete_table('valueaccounting_transfertypefacetvalue')
