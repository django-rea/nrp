...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CachedEventSummary.event_type'
        db.add_column('valueaccounting_cachedeventsummary', 'event_type',
    ...
    def backwards(self, orm):
        # Deleting field 'CachedEventSummary.event_type'
        db.delete_column('valueaccounting_cachedeventsummary', 'event_type_id')
