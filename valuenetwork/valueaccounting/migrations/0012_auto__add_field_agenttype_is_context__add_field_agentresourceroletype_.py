...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AgentType.is_context'
        db.add_column('valueaccounting_agenttype', 'is_context',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AgentResourceRoleType.is_owner'
        db.add_column('valueaccounting_agentresourceroletype', 'is_owner',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AgentResourceRole.owner_percentage'
        db.add_column('valueaccounting_agentresourcerole', 'owner_percentage',
    ...
    def backwards(self, orm):
        # Deleting field 'AgentType.is_context'
        db.delete_column('valueaccounting_agenttype', 'is_context')

        # Deleting field 'AgentResourceRoleType.is_owner'
        db.delete_column('valueaccounting_agentresourceroletype', 'is_owner')

        # Deleting field 'AgentResourceRole.owner_percentage'
        db.delete_column('valueaccounting_agentresourcerole', 'owner_percentage')
