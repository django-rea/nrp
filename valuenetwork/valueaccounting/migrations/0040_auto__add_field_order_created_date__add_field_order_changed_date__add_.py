...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.created_date'
        db.add_column('valueaccounting_order', 'created_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.changed_date'
        db.add_column('valueaccounting_order', 'changed_date',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Option.created_date'
        db.add_column('valueaccounting_option', 'created_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Option.changed_date'
        db.add_column('valueaccounting_option', 'changed_date',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Process.created_date'
        db.add_column('valueaccounting_process', 'created_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Process.changed_date'
        db.add_column('valueaccounting_process', 'changed_date',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Commitment.created_date'
        db.add_column('valueaccounting_commitment', 'created_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Commitment.changed_date'
        db.add_column('valueaccounting_commitment', 'changed_date',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EconomicAgent.created_by'
        db.add_column('valueaccounting_economicagent', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='agents_created', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'EconomicAgent.changed_by'
        db.add_column('valueaccounting_economicagent', 'changed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='agents_changed', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'EconomicAgent.changed_date'
        db.add_column('valueaccounting_economicagent', 'changed_date',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProcessType.created_date'
        db.add_column('valueaccounting_processtype', 'created_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProcessType.changed_date'
        db.add_column('valueaccounting_processtype', 'changed_date',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AgentResourceType.created_date'
        db.add_column('valueaccounting_agentresourcetype', 'created_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AgentResourceType.changed_date'
        db.add_column('valueaccounting_agentresourcetype', 'changed_date',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.created_date'
        db.add_column('valueaccounting_project', 'created_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.changed_date'
        db.add_column('valueaccounting_project', 'changed_date',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EconomicResourceType.created_date'
        db.add_column('valueaccounting_economicresourcetype', 'created_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EconomicResourceType.changed_date'
        db.add_column('valueaccounting_economicresourcetype', 'changed_date',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Feature.created_date'
        db.add_column('valueaccounting_feature', 'created_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Feature.changed_date'
        db.add_column('valueaccounting_feature', 'changed_date',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EconomicResource.changed_date'
        db.add_column('valueaccounting_economicresource', 'changed_date',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProcessTypeResourceType.created_date'
        db.add_column('valueaccounting_processtyperesourcetype', 'created_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProcessTypeResourceType.changed_date'
        db.add_column('valueaccounting_processtyperesourcetype', 'changed_date',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.created_date'
        db.delete_column('valueaccounting_order', 'created_date')

        # Deleting field 'Order.changed_date'
        db.delete_column('valueaccounting_order', 'changed_date')

        # Deleting field 'Option.created_date'
        db.delete_column('valueaccounting_option', 'created_date')

        # Deleting field 'Option.changed_date'
        db.delete_column('valueaccounting_option', 'changed_date')

        # Deleting field 'Process.created_date'
        db.delete_column('valueaccounting_process', 'created_date')

        # Deleting field 'Process.changed_date'
        db.delete_column('valueaccounting_process', 'changed_date')

        # Deleting field 'Commitment.created_date'
        db.delete_column('valueaccounting_commitment', 'created_date')

        # Deleting field 'Commitment.changed_date'
        db.delete_column('valueaccounting_commitment', 'changed_date')

        # Deleting field 'EconomicAgent.created_by'
        db.delete_column('valueaccounting_economicagent', 'created_by_id')

        # Deleting field 'EconomicAgent.changed_by'
        db.delete_column('valueaccounting_economicagent', 'changed_by_id')

        # Deleting field 'EconomicAgent.changed_date'
        db.delete_column('valueaccounting_economicagent', 'changed_date')

        # Deleting field 'ProcessType.created_date'
        db.delete_column('valueaccounting_processtype', 'created_date')

        # Deleting field 'ProcessType.changed_date'
        db.delete_column('valueaccounting_processtype', 'changed_date')

        # Deleting field 'AgentResourceType.created_date'
        db.delete_column('valueaccounting_agentresourcetype', 'created_date')

        # Deleting field 'AgentResourceType.changed_date'
        db.delete_column('valueaccounting_agentresourcetype', 'changed_date')

        # Deleting field 'Project.created_date'
        db.delete_column('valueaccounting_project', 'created_date')

        # Deleting field 'Project.changed_date'
        db.delete_column('valueaccounting_project', 'changed_date')

        # Deleting field 'EconomicResourceType.created_date'
        db.delete_column('valueaccounting_economicresourcetype', 'created_date')

        # Deleting field 'EconomicResourceType.changed_date'
        db.delete_column('valueaccounting_economicresourcetype', 'changed_date')

        # Deleting field 'Feature.created_date'
        db.delete_column('valueaccounting_feature', 'created_date')

        # Deleting field 'Feature.changed_date'
        db.delete_column('valueaccounting_feature', 'changed_date')

        # Deleting field 'EconomicResource.changed_date'
        db.delete_column('valueaccounting_economicresource', 'changed_date')

        # Deleting field 'ProcessTypeResourceType.created_date'
        db.delete_column('valueaccounting_processtyperesourcetype', 'created_date')

        # Deleting field 'ProcessTypeResourceType.changed_date'
        db.delete_column('valueaccounting_processtyperesourcetype', 'changed_date')
    ...
    models = {
        ...
        'valueaccounting.resourcerelationship': {
            'Meta': {'ordering': "('name',)", 'unique_together': "(('related_to', 'direction', 'materiality'),)", 'object_name': 'ResourceRelationship'},
