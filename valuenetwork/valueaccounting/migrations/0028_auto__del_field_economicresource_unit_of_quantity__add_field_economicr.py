...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EconomicResource.unit_of_quantity'
        db.delete_column('valueaccounting_economicresource', 'unit_of_quantity_id')

        # Adding field 'EconomicResource.value_per_unit'
        db.add_column('valueaccounting_economicresource', 'value_per_unit',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=8, decimal_places=2),
                      keep_default=False)

        # Adding field 'EconomicResource.value_per_unit_of_use'
        db.add_column('valueaccounting_economicresource', 'value_per_unit_of_use',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=8, decimal_places=2),
                      keep_default=False)

        # Adding field 'ValueEquation.percentage_behavior'
        db.add_column('valueaccounting_valueequation', 'percentage_behavior',
                      self.gf('django.db.models.fields.CharField')(default='straight', max_length=12),
                      keep_default=False)

        # Deleting field 'DistributionValueEquation.value_equation'
        db.delete_column('valueaccounting_distributionvalueequation', 'value_equation')

        # Deleting field 'DistributionValueEquation.value_equation_original'
        db.delete_column('valueaccounting_distributionvalueequation', 'value_equation_original_id')

        # Adding field 'DistributionValueEquation.value_equation_link'
        db.add_column('valueaccounting_distributionvalueequation', 'value_equation_link',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='distributions', null=True, to=orm['valueaccounting.ValueEquation']),
                      keep_default=False)

        # Adding field 'DistributionValueEquation.value_equation_content'
        db.add_column('valueaccounting_distributionvalueequation', 'value_equation_content',
        ...
        # Adding field 'EconomicResourceType.value_per_unit'
        db.add_column('valueaccounting_economicresourcetype', 'value_per_unit',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=8, decimal_places=2),
                      keep_default=False)

        # Adding field 'EconomicResourceType.value_per_unit_of_use'
        db.add_column('valueaccounting_economicresourcetype', 'value_per_unit_of_use',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=8, decimal_places=2),
                      keep_default=False)

        # Adding field 'ValueEquationBucket.filter_rule'
        db.add_column('valueaccounting_valueequationbucket', 'filter_rule',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AgentResourceRole.is_account'
        db.add_column('valueaccounting_agentresourcerole', 'is_account',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Claim.order'
        db.delete_column('valueaccounting_claim', 'order_id')


    def backwards(self, orm):
        # Adding field 'EconomicResource.unit_of_quantity'
        db.add_column('valueaccounting_economicresource', 'unit_of_quantity',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='resource_qty_units', null=True, to=orm['valueaccounting.Unit'], blank=True),
                      keep_default=False)

        # Deleting field 'EconomicResource.value_per_unit'
        db.delete_column('valueaccounting_economicresource', 'value_per_unit')

        # Deleting field 'EconomicResource.value_per_unit_of_use'
        db.delete_column('valueaccounting_economicresource', 'value_per_unit_of_use')

        # Deleting field 'ValueEquation.percentage_behavior'
        db.delete_column('valueaccounting_valueequation', 'percentage_behavior')

        # Adding field 'DistributionValueEquation.value_equation'
        db.add_column('valueaccounting_distributionvalueequation', 'value_equation',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DistributionValueEquation.value_equation_original'
        db.add_column('valueaccounting_distributionvalueequation', 'value_equation_original',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='distributions', null=True, to=orm['valueaccounting.ValueEquation'], blank=True),
                      keep_default=False)

        # Deleting field 'DistributionValueEquation.value_equation_link'
        db.delete_column('valueaccounting_distributionvalueequation', 'value_equation_link_id')

        # Deleting field 'DistributionValueEquation.value_equation_content'
        db.delete_column('valueaccounting_distributionvalueequation', 'value_equation_content')
        ...
        # Deleting field 'EconomicResourceType.value_per_unit'
        db.delete_column('valueaccounting_economicresourcetype', 'value_per_unit')

        # Deleting field 'EconomicResourceType.value_per_unit_of_use'
        db.delete_column('valueaccounting_economicresourcetype', 'value_per_unit_of_use')

        # Deleting field 'ValueEquationBucket.filter_rule'
        db.delete_column('valueaccounting_valueequationbucket', 'filter_rule')

        # Deleting field 'AgentResourceRole.is_account'
        db.delete_column('valueaccounting_agentresourcerole', 'is_account')

        # Adding field 'Claim.order'
        db.add_column('valueaccounting_claim', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='claims', null=True, to=orm['valueaccounting.Order'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'valueaccounting.agentresourcerole': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_account': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
