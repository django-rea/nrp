...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AgentResourceRole.is_contact'
        db.add_column('valueaccounting_agentresourcerole', 'is_contact',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AgentResourceRole.is_contact'
        db.delete_column('valueaccounting_agentresourcerole', 'is_contact')
