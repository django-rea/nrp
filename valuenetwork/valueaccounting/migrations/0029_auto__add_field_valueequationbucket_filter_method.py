...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ValueEquationBucket.filter_method'
        db.add_column('valueaccounting_valueequationbucket', 'filter_method',
                      self.gf('django.db.models.fields.CharField')(default='dates', max_length=12),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ValueEquationBucket.filter_method'
        db.delete_column('valueaccounting_valueequationbucket', 'filter_method')
