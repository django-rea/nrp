...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Facet.description'
        db.add_column('valueaccounting_facet', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FacetValue.description'
        db.add_column('valueaccounting_facetvalue', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Facet.description'
        db.delete_column('valueaccounting_facet', 'description')

        # Deleting field 'FacetValue.description'
        db.delete_column('valueaccounting_facetvalue', 'description')
