...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResourceTypeSpecialPrice.price_per_unit'
        db.add_column('valueaccounting_resourcetypespecialprice', 'price_per_unit',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=8, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResourceTypeSpecialPrice.price_per_unit'
        db.delete_column('valueaccounting_resourcetypespecialprice', 'price_per_unit')
