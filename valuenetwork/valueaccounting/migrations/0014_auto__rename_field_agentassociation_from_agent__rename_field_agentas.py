...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):        
        # Renaming field 'AgentAssociation.from_agent'
        db.rename_column('valueaccounting_agentassociation', 'from_agent_id', 'is_associate_id')

        # Renaming field 'AgentAssociation.to_agent'
        db.rename_column('valueaccounting_agentassociation', 'to_agent_id', 'has_associate_id')

        # Adding field 'AgentAssociationType.plural_name'
        db.add_column('valueaccounting_agentassociationtype', 'plural_name',
    ...
    def backwards(self, orm):
        # Renaming field 'AgentAssociation.from_agent'
        db.rename_column('valueaccounting_agentassociation', 'is_associate_id', 'from_agent_id')

        # Renaming field 'AgentAssociation.to_agent'
        db.rename_column('valueaccounting_agentassociation', 'has_associate_id', 'to_agent_id')

        # Deleting field 'AgentAssociationType.plural_name'
        db.delete_column('valueaccounting_agentassociationtype', 'plural_name')
