...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ValueEquationBucket.filter_agent'
        db.add_column('valueaccounting_valueequationbucket', 'filter_agent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='value_equation_filter_buckets', null=True, to=orm['valueaccounting.EconomicAgent']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ValueEquationBucket.filter_agent'
        db.delete_column('valueaccounting_valueequationbucket', 'filter_agent_id')
