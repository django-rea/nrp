...
class AuthenticatedUserAgentRequestMiddleware:
    """
    Middleware that makes an authenticated user with an associated agent, avaiable
    the agent as a request attribute.
    """
