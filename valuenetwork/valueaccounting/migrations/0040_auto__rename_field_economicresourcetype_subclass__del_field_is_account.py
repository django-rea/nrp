...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'EconomicResourceType.subclass'
        db.rename_column('valueaccounting_economicresourcetype', 'subclass', 'behavior')
    ...
    def backwards(self, orm):
        # Renaming field 'EconomicResourceType.subclass'
        db.rename_column('valueaccounting_economicresourcetype', 'behavior', 'subclass')
