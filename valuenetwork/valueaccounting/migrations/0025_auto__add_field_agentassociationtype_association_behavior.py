...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AgentAssociationType.association_behavior'
        db.add_column('valueaccounting_agentassociationtype', 'association_behavior',
                      self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AgentAssociationType.association_behavior'
        db.delete_column('valueaccounting_agentassociationtype', 'association_behavior')
