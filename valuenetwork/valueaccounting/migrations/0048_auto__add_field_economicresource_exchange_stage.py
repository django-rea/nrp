...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EconomicResource.exchange_stage'
        db.add_column('valueaccounting_economicresource', 'exchange_stage',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='resources_at_exchange_stage', null=True, to=orm['valueaccounting.AgentAssociationType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EconomicResource.exchange_stage'
        db.delete_column('valueaccounting_economicresource', 'exchange_stage_id')
