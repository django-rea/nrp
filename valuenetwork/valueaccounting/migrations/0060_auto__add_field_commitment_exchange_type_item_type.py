...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('valueaccounting_commitment', 'exchange_type_item_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='commitments', null=True, to=orm['valueaccounting.ExchangeTypeItemType']),
                      keep_default=False)
    ...
    models = {
        ...
        'valueaccounting.commitment': {
            ...
            'exchange_type_item_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'commitments'", 'null': 'True', 'to': "orm['valueaccounting.ExchangeTypeItemType']"}),
        ...
        'valueaccounting.exchangetypeitemtype': {
            'Meta': {'ordering': "('sequence',)", 'object_name': 'ExchangeTypeItemType'},
