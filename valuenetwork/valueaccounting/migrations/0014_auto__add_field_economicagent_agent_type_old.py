...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('valueaccounting_economicagent', 'agent_type_old',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='agents_old', to=orm['valueaccounting.AgentType']),
                      keep_default=False)
    ...
    models = {
        ...
        'valueaccounting.economicagent': {
            ...
            'agent_type_old': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'agents_old'", 'to': "orm['valueaccounting.AgentType']"}),
