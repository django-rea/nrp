...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('valueaccounting_exchangetype', (
            ...
            ('use_case', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exchange_types', null=True, to=orm['valueaccounting.UseCase'])),
            ...
            ('context_agent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exchange_types', null=True, to=orm['valueaccounting.EconomicAgent'])),
        ...
        db.add_column('valueaccounting_exchange', 'exchange_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exchanges', null=True, to=orm['valueaccounting.ExchangeType']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('valueaccounting_exchange', 'exchange_type_id')
