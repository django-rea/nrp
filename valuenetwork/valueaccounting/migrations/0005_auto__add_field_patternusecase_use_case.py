...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('valueaccounting_patternusecase', 'use_case',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='patterns', null=True, to=orm['valueaccounting.UseCase']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PatternUseCase.use_case'
        db.delete_column('valueaccounting_patternusecase', 'use_case_id')
