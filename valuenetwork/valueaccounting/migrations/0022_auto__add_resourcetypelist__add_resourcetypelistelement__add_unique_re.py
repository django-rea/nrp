...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ResourceTypeList'
        db.create_table('valueaccounting_resourcetypelist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('context_agent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='lists', null=True, to=orm['valueaccounting.EconomicAgent'])),
        ))
        db.send_create_signal('valueaccounting', ['ResourceTypeList'])

        # Adding model 'ResourceTypeListElement'
        db.create_table('valueaccounting_resourcetypelistelement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('resource_type_list', self.gf('django.db.models.fields.related.ForeignKey')(related_name='resource_types', to=orm['valueaccounting.ResourceTypeList'])),
            ('resource_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lists', to=orm['valueaccounting.EconomicResourceType'])),
            ('default_quantity', self.gf('django.db.models.fields.DecimalField')(default='1.0', max_digits=8, decimal_places=2)),
        ))
        db.send_create_signal('valueaccounting', ['ResourceTypeListElement'])

        # Adding unique constraint on 'ResourceTypeListElement', fields ['resource_type_list', 'resource_type']
        db.create_unique('valueaccounting_resourcetypelistelement', ['resource_type_list_id', 'resource_type_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ResourceTypeListElement', fields ['resource_type_list', 'resource_type']
        db.delete_unique('valueaccounting_resourcetypelistelement', ['resource_type_list_id', 'resource_type_id'])

        # Deleting model 'ResourceTypeList'
        db.delete_table('valueaccounting_resourcetypelist')

        # Deleting model 'ResourceTypeListElement'
        db.delete_table('valueaccounting_resourcetypelistelement')
    ...
    models = {
        ...
        'valueaccounting.resourcetypelistelement': {
            ...
            'resource_type_list': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'resource_types'", 'to': "orm['valueaccounting.ResourceTypeList']"})
        },
