...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AgentAssociationType.identifier'
        db.add_column('valueaccounting_agentassociationtype', 'identifier',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2014, 4, 9, 0, 0), unique=True, max_length=12),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AgentAssociationType.identifier'
        db.delete_column('valueaccounting_agentassociationtype', 'identifier')
