...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Commitment.project'
        db.delete_column('valueaccounting_commitment', 'project_id')

        # Deleting field 'CachedEventSummary.project'
        db.delete_column('valueaccounting_cachedeventsummary', 'project_id')

        # Deleting field 'AgentType.member_type'
        db.delete_column('valueaccounting_agenttype', 'member_type')

        # Deleting field 'ProcessType.project'
        db.delete_column('valueaccounting_processtype', 'project_id')

        # Deleting field 'Exchange.project'
        db.delete_column('valueaccounting_exchange', 'project_id')

        # Deleting field 'EconomicEvent.project'
        db.delete_column('valueaccounting_economicevent', 'project_id')


    def backwards(self, orm):
        # Adding field 'Process.project'
        db.add_column('valueaccounting_process', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='processes', null=True, to=orm['valueaccounting.Project'], blank=True),
                      keep_default=False)

        # Adding field 'Commitment.project'
        db.add_column('valueaccounting_commitment', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='commitments', null=True, to=orm['valueaccounting.Project'], blank=True),
                      keep_default=False)

        # Adding field 'CachedEventSummary.project'
        db.add_column('valueaccounting_cachedeventsummary', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='cached_events', null=True, to=orm['valueaccounting.Project'], blank=True),
                      keep_default=False)

        # Adding field 'AgentType.member_type'
        db.add_column('valueaccounting_agenttype', 'member_type',
        ...
        db.add_column('valueaccounting_processtype', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='process_types', null=True, to=orm['valueaccounting.Project'], blank=True),
                      keep_default=False)

        # Adding field 'Exchange.project'
        db.add_column('valueaccounting_exchange', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='exchanges', null=True, to=orm['valueaccounting.Project'], blank=True),
                      keep_default=False)

        # Adding field 'EconomicEvent.project'
        db.add_column('valueaccounting_economicevent', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='events', null=True, to=orm['valueaccounting.Project'], on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'valueaccounting.agentassociation': {
            'Meta': {'ordering': "('from_agent',)", 'object_name': 'AgentAssociation'},
