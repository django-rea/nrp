...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ValueEquation.live'
        db.add_column('valueaccounting_valueequation', 'live',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'ValueEquation.context_agent'
        db.alter_column('valueaccounting_valueequation', 'context_agent_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['valueaccounting.EconomicAgent']))
        # Adding field 'EconomicAgent.unit_of_claim_value'
        db.add_column('valueaccounting_economicagent', 'unit_of_claim_value',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='agents', null=True, to=orm['valueaccounting.Unit']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ValueEquation.live'
        db.delete_column('valueaccounting_valueequation', 'live')


        # Changing field 'ValueEquation.context_agent'
        db.alter_column('valueaccounting_valueequation', 'context_agent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['valueaccounting.EconomicAgent']))
        # Deleting field 'EconomicAgent.unit_of_claim_value'
        db.delete_column('valueaccounting_economicagent', 'unit_of_claim_value_id')
