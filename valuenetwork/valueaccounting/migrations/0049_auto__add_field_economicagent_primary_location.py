...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EconomicAgent.primary_location'
        db.add_column('valueaccounting_economicagent', 'primary_location',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='agents_at_location', null=True, to=orm['valueaccounting.Location']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EconomicAgent.primary_location'
        db.delete_column('valueaccounting_economicagent', 'primary_location_id')
