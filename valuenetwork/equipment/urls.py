...
urlpatterns = patterns("",
    url(r"^log-equipment-use/(?P<equip_resource_id>\d+)/(?P<equip_use_resource_id>\d+)/(?P<tech_resource_id>\d+)/(?P<agent_id>\d+)/(?P<pattern_id>\d+)/(?P<consumable_rt_id>\d+)/(?P<payment_rt_id>\d+)/$",
