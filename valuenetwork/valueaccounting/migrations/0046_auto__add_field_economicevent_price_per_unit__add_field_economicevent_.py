...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EconomicEvent.price_per_unit'
        db.add_column('valueaccounting_economicevent', 'price_per_unit',
                      self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=8, decimal_places=2),
                      keep_default=False)

        # Adding field 'EconomicEvent.unit_of_price'
        db.add_column('valueaccounting_economicevent', 'unit_of_price',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='event_price_units', null=True, to=orm['valueaccounting.Unit']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EconomicEvent.price_per_unit'
        db.delete_column('valueaccounting_economicevent', 'price_per_unit')

        # Deleting field 'EconomicEvent.unit_of_price'
        db.delete_column('valueaccounting_economicevent', 'unit_of_price_id')
    ...
    models = {
        ...
        'valueaccounting.economicevent': {
            ...
            'price_per_unit': ('django.db.models.fields.DecimalField', [], {'default': "'0.0'", 'max_digits': '8', 'decimal_places': '2'}),
