...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # renaming field 'PatternUseCase.logging_method'
        db.rename_column('valueaccounting_patternusecase', 'logging_method',  'use_case')


    def backwards(self, orm):
        # renaming field 'PatternUseCase.use_case'
        db.rename_column('valueaccounting_patternusecase', 'use_case', 'logging_method')
