...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EconomicEvent.accounting_reference'
        db.add_column('valueaccounting_economicevent', 'accounting_reference',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='events', null=True, to=orm['valueaccounting.AccountingReference']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EconomicEvent.accounting_reference'
        db.delete_column('valueaccounting_economicevent', 'accounting_reference_id')
