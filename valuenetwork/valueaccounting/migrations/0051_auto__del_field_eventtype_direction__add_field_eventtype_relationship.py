...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming field 'EventType.direction'
        db.rename_column('valueaccounting_eventtype', 'direction', 'relationship')

        # South does not rename fields automatically
        # Deleting field 'EventType.direction'
        #db.delete_column('valueaccounting_eventtype', 'direction')

        # Adding field 'EventType.relationship'
        #db.add_column('valueaccounting_eventtype', 'relationship',
    ...
    def backwards(self, orm):
        ...
        # Renaming field 'EventType.relationship'
        db.rename_column('valueaccounting_eventtype', 'relationship', 'direction')
        ...
        # Deleting field 'EventType.relationship'
        #db.delete_column('valueaccounting_eventtype', 'relationship')
    ...
    models = {
        ...
        'valueaccounting.patternfacetvalue': {
            'Meta': {'ordering': "('pattern', 'event_type', 'facet_value')", 'unique_together': "(('pattern', 'facet_value', 'process_relationship'),)", 'object_name': 'PatternFacetValue'},
