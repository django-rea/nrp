...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ExchangeTypeEventType'
        db.delete_table('valueaccounting_exchangetypeeventtype')
        ...
        db.create_table('valueaccounting_exchangetypeitemtype', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exchange_type_item_types_created', null=True, to=orm['auth.User'])),
            ('changed_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exchange_type_item_types_changed', null=True, to=orm['auth.User'])),
        ...
        # Deleting field 'EconomicEvent.exchange_type_event_type'
        db.delete_column('valueaccounting_economicevent', 'exchange_type_event_type_id')

        # Adding field 'EconomicEvent.exchange_type_item_type'
        db.add_column('valueaccounting_economicevent', 'exchange_type_item_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='events', null=True, to=orm['valueaccounting.ExchangeTypeItemType']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'ExchangeTypeEventType'
        db.create_table('valueaccounting_exchangetypeeventtype', (
            ('changed_date', self.gf('django.db.models.fields.DateField')(auto_now=True, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('is_contribution', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='exchange_type_event_types', to=orm['valueaccounting.EventType'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('changed_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='exchange_type_event_types_changed', null=True, to=orm['auth.User'], blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='exchange_type_event_types_created', null=True, to=orm['auth.User'], blank=True)),
            ('exchange_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='exchange_type_event_types', to=orm['valueaccounting.ExchangeType'])),
            ('created_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True)),
        ))
        db.send_create_signal('valueaccounting', ['ExchangeTypeEventType'])

        # Deleting model 'ExchangeTypeItemType'
        db.delete_table('valueaccounting_exchangetypeitemtype')

        # Adding field 'EconomicEvent.exchange_type_event_type'
        db.add_column('valueaccounting_economicevent', 'exchange_type_event_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='events', null=True, to=orm['valueaccounting.ExchangeTypeEventType'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'valueaccounting.economicevent': {
            ...
            'exchange_type_item_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'events'", 'null': 'True', 'to': "orm['valueaccounting.ExchangeTypeItemType']"}),
        ...
        'valueaccounting.exchangetypeitemtype': {
            'Meta': {'object_name': 'ExchangeTypeItemType'},
            'changed_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'exchange_type_item_types_changed'", 'null': 'True', 'to': "orm['auth.User']"}),
            'changed_date': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'exchange_type_item_types_created'", 'null': 'True', 'to': "orm['auth.User']"}),
            'created_date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'event_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'exchange_type_item_types'", 'to': "orm['valueaccounting.EventType']"}),
            'exchange_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'exchange_type_item_types'", 'to': "orm['valueaccounting.ExchangeType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_contribution': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
