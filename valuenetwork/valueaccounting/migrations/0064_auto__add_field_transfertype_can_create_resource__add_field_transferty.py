...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TransferType.can_create_resource'
        db.add_column('valueaccounting_transfertype', 'can_create_resource',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TransferType.is_currency'
        db.add_column('valueaccounting_transfertype', 'is_currency',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TransferType.give_agent_is_context'
        db.add_column('valueaccounting_transfertype', 'give_agent_is_context',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TransferType.receive_agent_is_context'
        db.add_column('valueaccounting_transfertype', 'receive_agent_is_context',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TransferType.give_agent_association_type'
        db.add_column('valueaccounting_transfertype', 'give_agent_association_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='transfer_types_give', null=True, to=orm['valueaccounting.AgentAssociationType']),
                      keep_default=False)

        # Adding field 'TransferType.receive_agent_association_type'
        db.add_column('valueaccounting_transfertype', 'receive_agent_association_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='transfer_types_receive', null=True, to=orm['valueaccounting.AgentAssociationType']),
                      keep_default=False)

        # Deleting field 'ExchangeType.transfer_to_agent_association_type'
        db.delete_column('valueaccounting_exchangetype', 'transfer_to_agent_association_type_id')

        # Deleting field 'ExchangeType.transfer_from_agent_association_type'
        db.delete_column('valueaccounting_exchangetype', 'transfer_from_agent_association_type_id')


    def backwards(self, orm):
        # Deleting field 'TransferType.can_create_resource'
        db.delete_column('valueaccounting_transfertype', 'can_create_resource')

        # Deleting field 'TransferType.is_currency'
        db.delete_column('valueaccounting_transfertype', 'is_currency')

        # Deleting field 'TransferType.give_agent_is_context'
        db.delete_column('valueaccounting_transfertype', 'give_agent_is_context')

        # Deleting field 'TransferType.receive_agent_is_context'
        db.delete_column('valueaccounting_transfertype', 'receive_agent_is_context')

        # Deleting field 'TransferType.give_agent_association_type'
        db.delete_column('valueaccounting_transfertype', 'give_agent_association_type_id')

        # Deleting field 'TransferType.receive_agent_association_type'
        db.delete_column('valueaccounting_transfertype', 'receive_agent_association_type_id')

        # Adding field 'ExchangeType.transfer_to_agent_association_type'
        db.add_column('valueaccounting_exchangetype', 'transfer_to_agent_association_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='exchange_types_to', null=True, to=orm['valueaccounting.AgentAssociationType'], blank=True),
                      keep_default=False)

        # Adding field 'ExchangeType.transfer_from_agent_association_type'
        db.add_column('valueaccounting_exchangetype', 'transfer_from_agent_association_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='exchange_types_from', null=True, to=orm['valueaccounting.AgentAssociationType'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'valueaccounting.distribution': {
            ...
            'value_equation': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'distributions'", 'null': 'True', 'to': "orm['valueaccounting.ValueEquation']"}),
        ...
        'valueaccounting.distributionvalueequation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'value_equation_content': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'value_equation_link': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'distributions_ve'", 'null': 'True', 'to': "orm['valueaccounting.ValueEquation']"})
        },
        ...
        'valueaccounting.economicevent': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'distribution': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'events'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['valueaccounting.Distribution']"}),
            ...
            'transfer': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'events'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['valueaccounting.Transfer']"}),
        ...
        'valueaccounting.incomeeventdistribution': {
            ...
            'distribution': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'cash_receipts'", 'null': 'True', 'blank': 'True', 'to': "orm['valueaccounting.Exchange']"}),
            'distribution_date': ('django.db.models.fields.DateField', [], {}),
            'distribution_ref': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'income_events'", 'null': 'True', 'to': "orm['valueaccounting.Distribution']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'valueaccounting.transfertype': {
            ...
            'can_create_resource': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'give_agent_association_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'transfer_types_give'", 'null': 'True', 'to': "orm['valueaccounting.AgentAssociationType']"}),
            'give_agent_is_context': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_contribution': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_currency': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_reciprocal': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'receive_agent_association_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'transfer_types_receive'", 'null': 'True', 'to': "orm['valueaccounting.AgentAssociationType']"}),
            'receive_agent_is_context': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
