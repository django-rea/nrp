...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Distribution.value_equation'
        db.add_column('valueaccounting_distribution', 'value_equation',
        ...
        # Adding field 'Distribution.value_equation_content'
        db.add_column('valueaccounting_distribution', 'value_equation_content',
        ...
        # Adding field 'EconomicEvent.transfer'
        db.add_column('valueaccounting_economicevent', 'transfer',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='events', null=True, on_delete=models.SET_NULL, to=orm['valueaccounting.Transfer']),
                      keep_default=False)

        # Adding field 'EconomicEvent.distribution'
        db.add_column('valueaccounting_economicevent', 'distribution',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='events', null=True, on_delete=models.SET_NULL, to=orm['valueaccounting.Distribution']),
                      keep_default=False)

        # Adding field 'IncomeEventDistribution.distribution_ref'
        db.add_column('valueaccounting_incomeeventdistribution', 'distribution_ref',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='income_events', null=True, to=orm['valueaccounting.Distribution']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Distribution.value_equation'
        db.delete_column('valueaccounting_distribution', 'value_equation_id')

        # Deleting field 'Distribution.value_equation_content'
        db.delete_column('valueaccounting_distribution', 'value_equation_content')

        # Adding field 'EconomicEvent.transfer_type'
        db.add_column('valueaccounting_economicevent', 'transfer_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='events', null=True, to=orm['valueaccounting.TransferType'], blank=True),
                      keep_default=False)

        # Deleting field 'EconomicEvent.transfer'
        db.delete_column('valueaccounting_economicevent', 'transfer_id')

        # Deleting field 'EconomicEvent.distribution'
        db.delete_column('valueaccounting_economicevent', 'distribution_id')

        # Deleting field 'IncomeEventDistribution.distribution_ref'
        db.delete_column('valueaccounting_incomeeventdistribution', 'distribution_ref_id')
