...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('valueaccounting_exchangetypeeventtype', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exchange_type_event_types_created', null=True, to=orm['auth.User'])),
            ('changed_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exchange_type_event_types_changed', null=True, to=orm['auth.User'])),
