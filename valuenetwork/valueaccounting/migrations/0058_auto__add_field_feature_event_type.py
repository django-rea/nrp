...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feature.event_type'
        db.add_column('valueaccounting_feature', 'event_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='features', to=orm['valueaccounting.EventType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feature.event_type'
        db.delete_column('valueaccounting_feature', 'event_type_id')
