...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EconomicResource.digital_currency_address'
        db.add_column('valueaccounting_economicresource', 'digital_currency_address',
                      self.gf('django.db.models.fields.CharField')(max_length=96, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EconomicEvent.digital_currency_tx_hash'
        db.add_column('valueaccounting_economicevent', 'digital_currency_tx_hash',
                      self.gf('django.db.models.fields.CharField')(max_length=96, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EconomicEvent.digital_currency_tx_state'
        db.add_column('valueaccounting_economicevent', 'digital_currency_tx_state',
                      self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True),
                      keep_default=False)


        # Changing field 'EconomicAgent.primary_location'
        db.alter_column('valueaccounting_economicagent', 'primary_location_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['valueaccounting.Location']))

    def backwards(self, orm):
        # Deleting field 'EconomicResource.digital_currency_address'
        db.delete_column('valueaccounting_economicresource', 'digital_currency_address')

        # Deleting field 'EconomicEvent.digital_currency_tx_hash'
        db.delete_column('valueaccounting_economicevent', 'digital_currency_tx_hash')

        # Deleting field 'EconomicEvent.digital_currency_tx_state'
        db.delete_column('valueaccounting_economicevent', 'digital_currency_tx_state')


        # Changing field 'EconomicAgent.primary_location'
        db.alter_column('valueaccounting_economicagent', 'primary_location_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['valueaccounting.Location']))
    ...
    models = {
        ...
        'valueaccounting.claim': {
            ...
            'against_agent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'claims_against'", 'null': 'True', 'to': "orm['valueaccounting.EconomicAgent']"}),
        ...
        'valueaccounting.commitment': {
            ...
            'transfer': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'commitments'", 'null': 'True', 'to': "orm['valueaccounting.Transfer']"}),
        ...
        'valueaccounting.economicevent': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'digital_currency_tx_hash': ('django.db.models.fields.CharField', [], {'max_length': '96', 'null': 'True', 'blank': 'True'}),
            'digital_currency_tx_state': ('django.db.models.fields.CharField', [], {'max_length': '12', 'null': 'True', 'blank': 'True'}),
            ...
            'is_to_distribute': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'valueaccounting.economicresource': {
            ...
            'digital_currency_address': ('django.db.models.fields.CharField', [], {'max_length': '96', 'null': 'True', 'blank': 'True'}),
        ...
        'valueaccounting.transfertypefacetvalue': {
            'Meta': {'ordering': "('transfer_type', 'facet_value')", 'unique_together': "(('transfer_type', 'facet_value'),)", 'object_name': 'TransferTypeFacetValue'},
            'facet_value': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'transfer_types'", 'to': "orm['valueaccounting.FacetValue']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'transfer_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'facet_values'", 'to': "orm['valueaccounting.TransferType']"})
        },
