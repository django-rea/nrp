...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResourceRelationship.related_to'
        db.add_column('valueaccounting_resourcerelationship', 'related_to',
                      self.gf('django.db.models.fields.CharField')(default='process', max_length=12),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResourceRelationship.related_to'
        db.delete_column('valueaccounting_resourcerelationship', 'related_to')
