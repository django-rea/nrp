...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exchange.use_case'
        db.add_column('valueaccounting_exchange', 'use_case',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exchanges', null=True, to=orm['valueaccounting.UseCase']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table('valueaccounting_exchangetype', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sub_exchange_types', null=True, to=orm['valueaccounting.ExchangeType'], blank=True)),
            ('process_pattern', self.gf('django.db.models.fields.related.ForeignKey')(related_name='exchange_types', null=True, to=orm['valueaccounting.ProcessPattern'], blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('changed_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='exchange_types_changed', null=True, to=orm['auth.User'], blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='exchange_types_created', null=True, to=orm['auth.User'], blank=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='exchange_types', null=True, to=orm['valueaccounting.Project'], blank=True)),
        ...
        db.add_column('valueaccounting_exchange', 'exchange_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='exchanges', null=True, to=orm['valueaccounting.ExchangeType'], on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Deleting field 'Exchange.use_case'
        db.delete_column('valueaccounting_exchange', 'use_case_id')
