...
urlpatterns += patterns("",
    ...
    url(r'^delete-transfer-commitment/(?P<commitment_id>\d+)/$', 'valuenetwork.valueaccounting.views.delete_transfer_commitment', 
        name="delete_transfer_commitment"),
    url(r'^transfer-from-commitment/(?P<commitment_id>\d+)/$', 'valuenetwork.valueaccounting.views.transfer_from_commitment', 
