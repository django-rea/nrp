...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EconomicEvent.stage'
        db.add_column('valueaccounting_economicevent', 'stage',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='events_creating_stage', null=True, to=orm['valueaccounting.ProcessType']),
                      keep_default=False)

        # Adding field 'EconomicEvent.exchange_stage'
        db.add_column('valueaccounting_economicevent', 'exchange_stage',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='events_creating_exchange_stage', null=True, to=orm['valueaccounting.AgentAssociationType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EconomicEvent.stage'
        db.delete_column('valueaccounting_economicevent', 'stage_id')

        # Deleting field 'EconomicEvent.exchange_stage'
        db.delete_column('valueaccounting_economicevent', 'exchange_stage_id')
    ...
    models = {
        ...
        'valueaccounting.economicevent': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
            'stage': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'events_creating_stage'", 'null': 'True', 'to': "orm['valueaccounting.ProcessType']"}),
