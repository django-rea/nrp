...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'EconomicResourceType', fields ['category', 'name']
        db.delete_unique('valueaccounting_economicresourcetype', ['category_id', 'name'])

        # Adding field 'EventType.label'
        db.add_column('valueaccounting_eventtype', 'label',
                      self.gf('django.db.models.fields.CharField')(default='unspecified', max_length=32),
                      keep_default=False)

        # Adding field 'EventType.inverse_label'
        db.add_column('valueaccounting_eventtype', 'inverse_label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True),
                      keep_default=False)

        # Adding field 'EventType.direction'
        db.add_column('valueaccounting_eventtype', 'direction',
                      self.gf('django.db.models.fields.CharField')(default='in', max_length=12),
                      keep_default=False)

        # Adding field 'EventType.related_to'
        db.add_column('valueaccounting_eventtype', 'related_to',
                      self.gf('django.db.models.fields.CharField')(default='process', max_length=12),
                      keep_default=False)

        # Adding field 'EconomicResourceType.unit_of_use'
        db.add_column('valueaccounting_economicresourcetype', 'unit_of_use',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='units_of_use', null=True, to=orm['valueaccounting.Unit']),
                      keep_default=False)

        # Adding field 'PatternFacetValue.event_type'
        db.add_column('valueaccounting_patternfacetvalue', 'event_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='patterns', to=orm['valueaccounting.EventType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventType.label'
        db.delete_column('valueaccounting_eventtype', 'label')

        # Deleting field 'EventType.inverse_label'
        db.delete_column('valueaccounting_eventtype', 'inverse_label')

        # Deleting field 'EventType.direction'
        db.delete_column('valueaccounting_eventtype', 'direction')

        # Deleting field 'EventType.related_to'
        db.delete_column('valueaccounting_eventtype', 'related_to')

        # Deleting field 'EconomicResourceType.unit_of_use'
        db.delete_column('valueaccounting_economicresourcetype', 'unit_of_use_id')

        # Adding unique constraint on 'EconomicResourceType', fields ['category', 'name']
        db.create_unique('valueaccounting_economicresourcetype', ['category_id', 'name'])

        # Deleting field 'PatternFacetValue.event_type'
        db.delete_column('valueaccounting_patternfacetvalue', 'event_type_id')
    ...
    models = {
        ...
        'valueaccounting.category': {
            ...
            'applies_to': ('django.db.models.fields.CharField', [], {'default': "'EconomicResourceType'", 'max_length': '128'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
        ...
        'valueaccounting.economicresourcetype': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'resource_types'", 'to': "orm['valueaccounting.Category']"}),
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'materiality': ('django.db.models.fields.CharField', [], {'default': "'intellectual'", 'max_length': '12'}),
        ...
        'valueaccounting.patternfacetvalue': {
            'Meta': {'ordering': "('pattern', 'process_relationship', 'facet_value')", 'unique_together': "(('pattern', 'facet_value', 'process_relationship'),)", 'object_name': 'PatternFacetValue'},
        ...
        'valueaccounting.patternloggingmethod': {
            'Meta': {'object_name': 'PatternLoggingMethod'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logging_method': ('django.db.models.fields.CharField', [], {'max_length': '12'}),
            'pattern': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'logging_methods'", 'to': "orm['valueaccounting.ProcessPattern']"})
        },
