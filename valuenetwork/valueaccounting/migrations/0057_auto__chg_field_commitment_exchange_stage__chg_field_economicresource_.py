...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Commitment.exchange_stage'
        db.alter_column('valueaccounting_commitment', 'exchange_stage_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['valueaccounting.ExchangeType']))

        # Changing field 'EconomicResource.exchange_stage'
        db.alter_column('valueaccounting_economicresource', 'exchange_stage_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['valueaccounting.ExchangeType']))

        # Changing field 'EconomicEvent.exchange_stage'
        db.alter_column('valueaccounting_economicevent', 'exchange_stage_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['valueaccounting.ExchangeType']))

    def backwards(self, orm):

        # Changing field 'Commitment.exchange_stage'
        db.alter_column('valueaccounting_commitment', 'exchange_stage_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['valueaccounting.AgentAssociationType']))

        # Changing field 'EconomicResource.exchange_stage'
        db.alter_column('valueaccounting_economicresource', 'exchange_stage_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['valueaccounting.AgentAssociationType']))

        # Changing field 'EconomicEvent.exchange_stage'
        db.alter_column('valueaccounting_economicevent', 'exchange_stage_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['valueaccounting.AgentAssociationType']))
