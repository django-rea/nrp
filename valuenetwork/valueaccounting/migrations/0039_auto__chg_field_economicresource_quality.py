...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EconomicResource.quality'
        db.alter_column('valueaccounting_economicresource', 'quality', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=0))

    def backwards(self, orm):

        # Changing field 'EconomicResource.quality'
        db.alter_column('valueaccounting_economicresource', 'quality', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=0))
