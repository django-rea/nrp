...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EconomicResourceType.unit_of_value'
        db.add_column('valueaccounting_economicresourcetype', 'unit_of_value',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='resource_type_value_units', null=True, to=orm['valueaccounting.Unit']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EconomicResourceType.unit_of_value'
        db.delete_column('valueaccounting_economicresourcetype', 'unit_of_value_id')
