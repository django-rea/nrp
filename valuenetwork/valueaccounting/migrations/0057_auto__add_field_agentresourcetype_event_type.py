...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AgentResourceType.event_type'
        db.add_column('valueaccounting_agentresourcetype', 'event_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='agent_resource_types', to=orm['valueaccounting.EventType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AgentResourceType.event_type'
        db.delete_column('valueaccounting_agentresourcetype', 'event_type_id')
