...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ValueEquation.context_agent'
        db.add_column('valueaccounting_valueequation', 'context_agent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='value_equations', null=True, to=orm['valueaccounting.EconomicAgent']),
                      keep_default=False)

        # Adding field 'AgentResourceType.value_per_unit'
        db.add_column('valueaccounting_agentresourcetype', 'value_per_unit',
    ...
    def backwards(self, orm):
        ...
        db.create_table('valueaccounting_agentvalueequation', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='value_equations_assigned', null=True, to=orm['auth.User'], blank=True)),
        ...
        # Deleting field 'ValueEquation.context_agent'
        db.delete_column('valueaccounting_valueequation', 'context_agent_id')

        # Deleting field 'AgentResourceType.value_per_unit'
        db.delete_column('valueaccounting_agentresourcetype', 'value_per_unit')
    ...
    models = {
        ...
        'valueaccounting.valueequation': {
            ...
            'context_agent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'value_equations'", 'null': 'True', 'to': "orm['valueaccounting.EconomicAgent']"}),
        ...
        'valueaccounting.valueequationbucket': {
            ...
            'filter_method': ('django.db.models.fields.CharField', [], {'default': "'dates'", 'max_length': '12'}),
