...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ValueEquationBucket.filter_method'
        db.alter_column('valueaccounting_valueequationbucket', 'filter_method', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))

    def backwards(self, orm):

        # Changing field 'ValueEquationBucket.filter_method'
        db.alter_column('valueaccounting_valueequationbucket', 'filter_method', self.gf('django.db.models.fields.CharField')(max_length=12))
