...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ClaimEvent.event'
        db.alter_column('valueaccounting_claimevent', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['valueaccounting.EconomicEvent']))
        # Adding field 'Claim.order'
        db.add_column('valueaccounting_claim', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='claims', null=True, to=orm['valueaccounting.Order']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ClaimEvent.event'
        db.alter_column('valueaccounting_claimevent', 'event_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['valueaccounting.EconomicEvent']))
    ...
    models = {
        ...
        'valueaccounting.claim': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'claims'", 'null': 'True', 'to': "orm['valueaccounting.Order']"}),
        ...
        'valueaccounting.distributionvalueequation': {
            ...
            'value_equation_original': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'distributions'", 'null': 'True', 'to': "orm['valueaccounting.ValueEquation']"})
        },
