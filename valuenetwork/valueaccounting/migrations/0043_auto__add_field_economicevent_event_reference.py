...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EconomicEvent.event_reference'
        db.add_column('valueaccounting_economicevent', 'event_reference',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EconomicEvent.event_reference'
        db.delete_column('valueaccounting_economicevent', 'event_reference')
