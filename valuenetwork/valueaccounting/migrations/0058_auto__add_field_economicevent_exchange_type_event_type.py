...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('valueaccounting_economicevent', 'exchange_type_event_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='events', null=True, to=orm['valueaccounting.ExchangeTypeEventType']),
                      keep_default=False)
    ...
    models = {
        ...
        'valueaccounting.economicevent': {
            ...
            'exchange_type_event_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'events'", 'null': 'True', 'to': "orm['valueaccounting.ExchangeTypeEventType']"}),
