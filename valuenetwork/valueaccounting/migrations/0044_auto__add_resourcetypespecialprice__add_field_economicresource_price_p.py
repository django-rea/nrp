...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ResourceTypeSpecialPrice'
        db.create_table('valueaccounting_resourcetypespecialprice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('resource_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='prices', to=orm['valueaccounting.EconomicResourceType'])),
            ('identifier', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('stage', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='price_at_stage', null=True, to=orm['valueaccounting.ProcessType'])),
        ))
        db.send_create_signal('valueaccounting', ['ResourceTypeSpecialPrice'])

        # Adding field 'EconomicResource.price_per_unit'
        db.add_column('valueaccounting_economicresource', 'price_per_unit',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=8, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ResourceTypeSpecialPrice'
        db.delete_table('valueaccounting_resourcetypespecialprice')

        # Deleting field 'EconomicResource.price_per_unit'
        db.delete_column('valueaccounting_economicresource', 'price_per_unit')
