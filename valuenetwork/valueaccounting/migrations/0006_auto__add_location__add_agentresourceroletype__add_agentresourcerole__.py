...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('valueaccounting_location', (
        ...
        db.send_create_signal('valueaccounting', ['Location'])

        # Adding model 'AgentResourceRoleType'
        db.create_table('valueaccounting_agentresourceroletype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('valueaccounting', ['AgentResourceRoleType'])

        # Adding model 'AgentResourceRole'
        db.create_table('valueaccounting_agentresourcerole', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('agent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='agent_resource_roles', to=orm['valueaccounting.EconomicAgent'])),
            ('resource', self.gf('django.db.models.fields.related.ForeignKey')(related_name='agent_resource_roles', to=orm['valueaccounting.EconomicResource'])),
            ('role', self.gf('django.db.models.fields.related.ForeignKey')(related_name='agent_resource_roles', to=orm['valueaccounting.AgentResourceRoleType'])),
        ))
        db.send_create_signal('valueaccounting', ['AgentResourceRole'])

        # Deleting field 'EconomicResource.custodian'
        db.delete_column('valueaccounting_economicresource', 'custodian_id')

        # Deleting field 'EconomicResource.owner'
        db.delete_column('valueaccounting_economicresource', 'owner_id')

        # Adding field 'EconomicResource.access_rules'
        db.add_column('valueaccounting_economicresource', 'access_rules',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EconomicResource.current_location'
        db.add_column('valueaccounting_economicresource', 'current_location',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='resources_at_location', null=True, to=orm['valueaccounting.Location']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Location'
        db.delete_table('valueaccounting_location')

        # Deleting model 'AgentResourceRoleType'
        db.delete_table('valueaccounting_agentresourceroletype')

        # Deleting model 'AgentResourceRole'
        db.delete_table('valueaccounting_agentresourcerole')

        # Adding field 'EconomicResource.custodian'
        db.add_column('valueaccounting_economicresource', 'custodian',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='custody_resources', null=True, to=orm['valueaccounting.EconomicAgent'], blank=True),
                      keep_default=False)

        # Adding field 'EconomicResource.owner'
        db.add_column('valueaccounting_economicresource', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='owned_resources', null=True, to=orm['valueaccounting.EconomicAgent'], blank=True),
                      keep_default=False)

        # Deleting field 'EconomicResource.access_rules'
        db.delete_column('valueaccounting_economicresource', 'access_rules')

        # Deleting field 'EconomicResource.current_location'
        db.delete_column('valueaccounting_economicresource', 'current_location_id')
