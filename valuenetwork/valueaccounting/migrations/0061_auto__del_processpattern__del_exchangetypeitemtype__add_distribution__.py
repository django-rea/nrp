...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('valueaccounting_distribution', (
            ...
            ('pattern', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='distributions', null=True, to=orm['valueaccounting.Pattern'])),
        ...
        db.create_table('valueaccounting_pattern', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ))
        db.send_create_signal('valueaccounting', ['Pattern'])
        ...
        # Deleting field 'Process.process_pattern'
        db.delete_column('valueaccounting_process', 'process_pattern_id')

        # Adding field 'Process.pattern'
        db.add_column('valueaccounting_process', 'pattern',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='processes', null=True, to=orm['valueaccounting.Pattern']),
                      keep_default=False)
        ...
        # Changing field 'PatternUseCase.pattern'
        db.alter_column('valueaccounting_patternusecase', 'pattern_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['valueaccounting.Pattern']))
        ...
        # Deleting field 'ProcessType.process_pattern'
        db.delete_column('valueaccounting_processtype', 'process_pattern_id')

        # Adding field 'ProcessType.pattern'
        db.add_column('valueaccounting_processtype', 'pattern',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='process_types', null=True, to=orm['valueaccounting.Pattern']),
                      keep_default=False)

        # Deleting field 'Exchange.process_pattern'
        db.delete_column('valueaccounting_exchange', 'process_pattern_id')

        # Adding field 'Exchange.pattern'
        db.add_column('valueaccounting_exchange', 'pattern',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exchanges', null=True, to=orm['valueaccounting.Pattern']),
                      keep_default=False)


        # Changing field 'PatternFacetValue.pattern'
        db.alter_column('valueaccounting_patternfacetvalue', 'pattern_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['valueaccounting.Pattern']))
        # Deleting field 'ExchangeType.process_pattern'
        db.delete_column('valueaccounting_exchangetype', 'process_pattern_id')

        # Adding field 'ExchangeType.pattern'
        db.add_column('valueaccounting_exchangetype', 'pattern',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exchange_types', null=True, to=orm['valueaccounting.Pattern']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table('valueaccounting_pattern')
        ...
        # Adding field 'Process.process_pattern'
        db.add_column('valueaccounting_process', 'process_pattern',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='processes', null=True, to=orm['valueaccounting.ProcessPattern'], blank=True),
                      keep_default=False)

        # Deleting field 'Process.pattern'
        db.delete_column('valueaccounting_process', 'pattern_id')
        ...
        # Changing field 'PatternUseCase.pattern'
        db.alter_column('valueaccounting_patternusecase', 'pattern_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['valueaccounting.ProcessPattern']))
        ...
        # Adding field 'ProcessType.process_pattern'
        db.add_column('valueaccounting_processtype', 'process_pattern',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='process_types', null=True, to=orm['valueaccounting.ProcessPattern'], blank=True),
                      keep_default=False)

        # Deleting field 'ProcessType.pattern'
        db.delete_column('valueaccounting_processtype', 'pattern_id')

        # Adding field 'Exchange.process_pattern'
        db.add_column('valueaccounting_exchange', 'process_pattern',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='exchanges', null=True, to=orm['valueaccounting.ProcessPattern'], blank=True),
                      keep_default=False)

        # Deleting field 'Exchange.pattern'
        db.delete_column('valueaccounting_exchange', 'pattern_id')


        # Changing field 'PatternFacetValue.pattern'
        db.alter_column('valueaccounting_patternfacetvalue', 'pattern_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['valueaccounting.ProcessPattern']))
        # Adding field 'ExchangeType.process_pattern'
        db.add_column('valueaccounting_exchangetype', 'process_pattern',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='exchange_types', null=True, to=orm['valueaccounting.ProcessPattern'], blank=True),
                      keep_default=False)

        # Deleting field 'ExchangeType.pattern'
        db.delete_column('valueaccounting_exchangetype', 'pattern_id')
    ...
    models = {
        ...
        'valueaccounting.distribution': {
            ...
            'pattern': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'distributions'", 'null': 'True', 'to': "orm['valueaccounting.Pattern']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
        ...
        'valueaccounting.exchange': {
            ...
            'pattern': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'exchanges'", 'null': 'True', 'to': "orm['valueaccounting.Pattern']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
        ...
        'valueaccounting.exchangetype': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'pattern': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'exchange_types'", 'null': 'True', 'to': "orm['valueaccounting.Pattern']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
        ...
        'valueaccounting.patternfacetvalue': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pattern': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'facets'", 'to': "orm['valueaccounting.Pattern']"})
        },
        'valueaccounting.patternusecase': {
            'Meta': {'object_name': 'PatternUseCase'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pattern': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'use_cases'", 'to': "orm['valueaccounting.Pattern']"}),
        ...
        'valueaccounting.process': {
            ...
            'pattern': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'processes'", 'null': 'True', 'to': "orm['valueaccounting.Pattern']"}),
        ...
        'valueaccounting.processtype': {
            ...
            'pattern': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'process_types'", 'null': 'True', 'to': "orm['valueaccounting.Pattern']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
            'url': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'})
        },
