...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResourceRelationship.unit'
        db.add_column('valueaccounting_resourcerelationship', 'unit',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='relationship_units', null=True, to=orm['valueaccounting.Unit']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResourceRelationship.unit'
        db.delete_column('valueaccounting_resourcerelationship', 'unit_id')
