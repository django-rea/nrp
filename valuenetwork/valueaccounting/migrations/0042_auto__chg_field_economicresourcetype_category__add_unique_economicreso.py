...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EconomicResourceType.category'
        db.alter_column('valueaccounting_economicresourcetype', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['valueaccounting.Category']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'EconomicResourceType.category'
        db.alter_column('valueaccounting_economicresourcetype', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['valueaccounting.Category']))
