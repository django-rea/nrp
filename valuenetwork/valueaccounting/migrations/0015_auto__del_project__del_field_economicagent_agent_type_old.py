...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('valueaccounting_project', (
            ('project_team', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_team', null=True, to=orm['valueaccounting.EconomicAgent'], blank=True)),
            ('changed_date', self.gf('django.db.models.fields.DateField')(auto_now=True, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sub_projects', null=True, to=orm['valueaccounting.Project'], blank=True)),
            ('importance', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=3, decimal_places=0)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('changed_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='projects_changed', null=True, to=orm['auth.User'], blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='projects_created', null=True, to=orm['auth.User'], blank=True)),
        ...
        db.add_column('valueaccounting_economicagent', 'agent_type_old',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='agents_old', null=True, to=orm['valueaccounting.AgentType'], blank=True),
                      keep_default=False)
