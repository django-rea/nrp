...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UseCaseEventType'
        db.create_table('valueaccounting_usecaseeventtype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('use_case', self.gf('django.db.models.fields.related.ForeignKey')(related_name='event_types', to=orm['valueaccounting.UseCase'])),
            ('event_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='use_cases', to=orm['valueaccounting.EventType'])),
        ))
        db.send_create_signal('valueaccounting', ['UseCaseEventType'])


    def backwards(self, orm):
        # Deleting model 'UseCaseEventType'
        db.delete_table('valueaccounting_usecaseeventtype')
