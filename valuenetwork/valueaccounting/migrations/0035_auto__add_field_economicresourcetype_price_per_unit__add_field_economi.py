...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EconomicResourceType.price_per_unit'
        db.add_column('valueaccounting_economicresourcetype', 'price_per_unit',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=8, decimal_places=2),
                      keep_default=False)

        # Adding field 'EconomicResourceType.unit_of_price'
        db.add_column('valueaccounting_economicresourcetype', 'unit_of_price',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='resource_type_price_units', null=True, to=orm['valueaccounting.Unit']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EconomicResourceType.price_per_unit'
        db.delete_column('valueaccounting_economicresourcetype', 'price_per_unit')

        # Deleting field 'EconomicResourceType.unit_of_price'
        db.delete_column('valueaccounting_economicresourcetype', 'unit_of_price_id')
