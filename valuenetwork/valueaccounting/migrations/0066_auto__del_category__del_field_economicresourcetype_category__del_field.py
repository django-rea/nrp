...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('valueaccounting_category', (
            ...
            ('applies_to', self.gf('django.db.models.fields.CharField')(default='EconomicResourceType', max_length=128)),
        ...
        db.add_column('valueaccounting_economicresourcetype', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='resource_types', to=orm['valueaccounting.Category']),
                      keep_default=False)

        # Adding field 'Feature.option_category'
        db.add_column('valueaccounting_feature', 'option_category',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='features', null=True, to=orm['valueaccounting.Category'], blank=True),
                      keep_default=False)
