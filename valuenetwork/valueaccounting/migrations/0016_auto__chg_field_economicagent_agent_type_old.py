...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EconomicAgent.agent_type_old'
        db.alter_column('valueaccounting_economicagent', 'agent_type_old_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['valueaccounting.AgentType']))

    def backwards(self, orm):

        # Changing field 'EconomicAgent.agent_type_old'
        db.alter_column('valueaccounting_economicagent', 'agent_type_old_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['valueaccounting.AgentType']))
