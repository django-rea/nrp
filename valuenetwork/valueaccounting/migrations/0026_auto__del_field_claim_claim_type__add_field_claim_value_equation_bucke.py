...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Claim.claim_type'
        db.delete_column('valueaccounting_claim', 'claim_type_id')

        # Adding field 'Claim.value_equation_bucket_rule'
        db.add_column('valueaccounting_claim', 'value_equation_bucket_rule',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='claims', null=True, to=orm['valueaccounting.ValueEquationBucketRule']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Claim.claim_type'
        db.add_column('valueaccounting_claim', 'claim_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='claims', to=orm['valueaccounting.EventType']),
                      keep_default=False)

        # Deleting field 'Claim.value_equation_bucket_rule'
        db.delete_column('valueaccounting_claim', 'value_equation_bucket_rule_id')
