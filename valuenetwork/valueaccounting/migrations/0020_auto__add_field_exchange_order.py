...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exchange.order'
        db.add_column('valueaccounting_exchange', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cash_receipts', null=True, to=orm['valueaccounting.Order']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Exchange.order'
        db.delete_column('valueaccounting_exchange', 'order_id')
