...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Commitment.relationship'
        db.alter_column('valueaccounting_commitment', 'relationship_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['valueaccounting.ResourceRelationship']))

        # Changing field 'AgentResourceType.relationship'
        db.alter_column('valueaccounting_agentresourcetype', 'relationship_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['valueaccounting.ResourceRelationship']))

        # Changing field 'Feature.relationship'
        db.alter_column('valueaccounting_feature', 'relationship_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['valueaccounting.ResourceRelationship']))

        # Changing field 'ProcessTypeResourceType.relationship'
        db.alter_column('valueaccounting_processtyperesourcetype', 'relationship_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['valueaccounting.ResourceRelationship']))

    def backwards(self, orm):

        # Changing field 'Commitment.relationship'
        db.alter_column('valueaccounting_commitment', 'relationship_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['valueaccounting.ResourceRelationship']))

        # Changing field 'AgentResourceType.relationship'
        db.alter_column('valueaccounting_agentresourcetype', 'relationship_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['valueaccounting.ResourceRelationship']))

        # Changing field 'Feature.relationship'
        db.alter_column('valueaccounting_feature', 'relationship_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['valueaccounting.ResourceRelationship']))

        # Changing field 'ProcessTypeResourceType.relationship'
        db.alter_column('valueaccounting_processtyperesourcetype', 'relationship_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['valueaccounting.ResourceRelationship']))
