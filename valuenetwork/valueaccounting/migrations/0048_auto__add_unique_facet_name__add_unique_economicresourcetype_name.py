...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Facet', fields ['name']
        db.create_unique('valueaccounting_facet', ['name'])

        # Adding unique constraint on 'EconomicResourceType', fields ['name']
        db.create_unique('valueaccounting_economicresourcetype', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'EconomicResourceType', fields ['name']
        db.delete_unique('valueaccounting_economicresourcetype', ['name'])

        # Removing unique constraint on 'Facet', fields ['name']
        db.delete_unique('valueaccounting_facet', ['name'])
