...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExchangeType.context_agent'
        db.delete_column('valueaccounting_exchangetype', 'context_agent_id')
    ...
    def backwards(self, orm):
        # Adding field 'ExchangeType.context_agent'
        db.add_column('valueaccounting_exchangetype', 'context_agent',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='exchange_types', null=True, to=orm['valueaccounting.EconomicAgent'], blank=True),
                      keep_default=False)
