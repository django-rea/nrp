...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AgentResourceType.description'
        db.add_column('valueaccounting_agentresourcetype', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProcessTypeResourceType.description'
        db.add_column('valueaccounting_processtyperesourcetype', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AgentResourceType.description'
        db.delete_column('valueaccounting_agentresourcetype', 'description')

        # Deleting field 'ProcessTypeResourceType.description'
        db.delete_column('valueaccounting_processtyperesourcetype', 'description')
