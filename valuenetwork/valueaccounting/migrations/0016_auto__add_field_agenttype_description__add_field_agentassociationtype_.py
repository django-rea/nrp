...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AgentAssociationType.description'
        db.add_column('valueaccounting_agentassociationtype', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AgentAssociationType.label'
        db.add_column('valueaccounting_agentassociationtype', 'label',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True),
                      keep_default=False)

        # Adding field 'AgentAssociationType.inverse_label'
        db.add_column('valueaccounting_agentassociationtype', 'inverse_label',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True),
                      keep_default=False)

        # Adding field 'AgentAssociationType.is_context'
        db.add_column('valueaccounting_agentassociationtype', 'is_context',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AgentAssociationType.description'
        db.delete_column('valueaccounting_agentassociationtype', 'description')

        # Deleting field 'AgentAssociationType.label'
        db.delete_column('valueaccounting_agentassociationtype', 'label')

        # Deleting field 'AgentAssociationType.inverse_label'
        db.delete_column('valueaccounting_agentassociationtype', 'inverse_label')

        # Deleting field 'AgentAssociationType.is_context'
        db.delete_column('valueaccounting_agentassociationtype', 'is_context')
