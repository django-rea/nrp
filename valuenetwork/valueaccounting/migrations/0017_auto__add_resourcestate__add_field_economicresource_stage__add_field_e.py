...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ResourceState'
        db.create_table('valueaccounting_resourcestate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('valueaccounting', ['ResourceState'])

        # Adding field 'EconomicResource.stage'
        db.add_column('valueaccounting_economicresource', 'stage',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='resources_at_stage', null=True, to=orm['valueaccounting.ProcessType']),
                      keep_default=False)

        # Adding field 'EconomicResource.state'
        db.add_column('valueaccounting_economicresource', 'state',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='resources_at_state', null=True, to=orm['valueaccounting.ResourceState']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ResourceState'
        db.delete_table('valueaccounting_resourcestate')

        # Deleting field 'EconomicResource.stage'
        db.delete_column('valueaccounting_economicresource', 'stage_id')

        # Deleting field 'EconomicResource.state'
        db.delete_column('valueaccounting_economicresource', 'state_id')
