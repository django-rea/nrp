...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exchange.customer'
        db.add_column('valueaccounting_exchange', 'customer',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exchange_for_customer', null=True, to=orm['valueaccounting.EconomicAgent']),
                      keep_default=False)


        # Changing field 'Exchange.url'
        db.alter_column('valueaccounting_exchange', 'url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting field 'Exchange.customer'
        db.delete_column('valueaccounting_exchange', 'customer_id')


        # Changing field 'Exchange.url'
        db.alter_column('valueaccounting_exchange', 'url', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
    ...
    models = {
        ...
        'valueaccounting.exchange': {
            ...
            'created_date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'exchange_for_customer'", 'null': 'True', 'to': "orm['valueaccounting.EconomicAgent']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
