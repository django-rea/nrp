...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'CashReceiptDistribution'
        db.delete_table('valueaccounting_cashreceiptdistribution')

        # Adding model 'IncomeEventDistribution'
        db.create_table('valueaccounting_incomeeventdistribution', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('distribution_date', self.gf('django.db.models.fields.DateField')()),
            ('distribution', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cash_receipts', to=orm['valueaccounting.Exchange'])),
            ('income_event', self.gf('django.db.models.fields.related.ForeignKey')(related_name='distributions', to=orm['valueaccounting.EconomicEvent'])),
            ('quantity', self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=8, decimal_places=2)),
            ('unit_of_quantity', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='units', null=True, to=orm['valueaccounting.Unit'])),
        ))
        db.send_create_signal('valueaccounting', ['IncomeEventDistribution'])


    def backwards(self, orm):
        # Adding model 'CashReceiptDistribution'
        db.create_table('valueaccounting_cashreceiptdistribution', (
            ('distribution_date', self.gf('django.db.models.fields.DateField')()),
            ('unit_of_quantity', self.gf('django.db.models.fields.related.ForeignKey')(related_name='units', null=True, to=orm['valueaccounting.Unit'], blank=True)),
            ('distribution', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cash_receipts', to=orm['valueaccounting.Exchange'])),
            ('cash_receipt', self.gf('django.db.models.fields.related.ForeignKey')(related_name='distributions', to=orm['valueaccounting.EconomicEvent'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('quantity', self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=8, decimal_places=2)),
        ))
        db.send_create_signal('valueaccounting', ['CashReceiptDistribution'])

        # Deleting model 'IncomeEventDistribution'
        db.delete_table('valueaccounting_incomeeventdistribution')
