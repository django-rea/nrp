...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('valueaccounting_process', 'process_pattern',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='processes', null=True, to=orm['valueaccounting.ProcessPattern']),
                      keep_default=False)

        # Adding field 'ProcessType.process_pattern'
        db.add_column('valueaccounting_processtype', 'process_pattern',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='process_types', null=True, to=orm['valueaccounting.ProcessPattern']),
                      keep_default=False)
