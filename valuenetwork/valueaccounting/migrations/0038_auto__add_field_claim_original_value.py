...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Claim.original_value'
        db.add_column('valueaccounting_claim', 'original_value',
                      self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=8, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Claim.original_value'
        db.delete_column('valueaccounting_claim', 'original_value')
