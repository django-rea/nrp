...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PatternUseCase.use_case'
        #db.delete_column('valueaccounting_patternusecase', 'use_case')

        # Adding field 'PatternUseCase.use_case_temp'
        #db.add_column('valueaccounting_patternusecase', 'use_case_temp',
        #              self.gf('django.db.models.fields.CharField')(default='rand', max_length=12),
        #              keep_default=False)

        db.rename_column('valueaccounting_patternusecase', 'use_case', 'use_case_temp')


    def backwards(self, orm):
        # Adding field 'PatternUseCase.use_case'
        #db.add_column('valueaccounting_patternusecase', 'use_case',
        #              self.gf('django.db.models.fields.CharField')(default='rand', max_length=12),
        #              keep_default=False)

        # Deleting field 'PatternUseCase.use_case_temp'
        #db.delete_column('valueaccounting_patternusecase', 'use_case_temp')

        db.rename_column('valueaccounting_patternusecase', 'use_case_temp', 'use_case')
    ...
    models = {
        ...
        'valueaccounting.patternusecase': {
            ...
            'use_case_temp': ('django.db.models.fields.CharField', [], {'max_length': '12'})
        },
