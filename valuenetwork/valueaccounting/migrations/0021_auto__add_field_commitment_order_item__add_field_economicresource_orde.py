...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Commitment.order_item'
        db.add_column('valueaccounting_commitment', 'order_item',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='stream_commitments', null=True, to=orm['valueaccounting.Commitment']),
                      keep_default=False)

        # Adding field 'EconomicResource.order_item'
        db.add_column('valueaccounting_economicresource', 'order_item',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='stream_resources', null=True, to=orm['valueaccounting.Commitment']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Commitment.order_item'
        db.delete_column('valueaccounting_commitment', 'order_item_id')

        # Deleting field 'EconomicResource.order_item'
        db.delete_column('valueaccounting_economicresource', 'order_item_id')
