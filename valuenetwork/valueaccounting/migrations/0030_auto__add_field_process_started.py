...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Process.started'
        db.add_column('valueaccounting_process', 'started',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Process.started'
        db.delete_column('valueaccounting_process', 'started')
