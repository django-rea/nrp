...
class MembershipRequest(models.Model):
    ...
    work_for_shares = models.BooleanField(_('work for shares'), default=False,
        help_text=_("You can get shares for hours of work. 1 share = 6 hours of work. If you choose this option, we will send you a list of tasks and the deadline. You won't have full access before the tasks are accomplished."))
