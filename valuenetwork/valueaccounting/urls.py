...
urlpatterns += patterns("",
    ...
    url(r'^add-transfer-commitment/(?P<transfer_type_id>\d+)/$', 'valuenetwork.valueaccounting.views.add_transfer_commitment', 
    ...
    url(r'^add-transfer/(?P<exchange_id>\d+)/$', 'valuenetwork.valueaccounting.views.add_transfer', 
        name="add_transfer"), 
