...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'AgentResourceType.relationship'
        db.alter_column('valueaccounting_agentresourcetype', 'relationship_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['valueaccounting.ResourceRelationship']))

        # Changing field 'Feature.relationship'
        db.alter_column('valueaccounting_feature', 'relationship_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['valueaccounting.ResourceRelationship']))

        # Changing field 'ProcessTypeResourceType.relationship'
        db.alter_column('valueaccounting_processtyperesourcetype', 'relationship_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['valueaccounting.ResourceRelationship']))
