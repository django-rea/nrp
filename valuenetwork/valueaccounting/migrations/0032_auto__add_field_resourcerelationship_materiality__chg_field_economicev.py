...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResourceRelationship.materiality'
        db.add_column('valueaccounting_resourcerelationship', 'materiality',
                      self.gf('django.db.models.fields.CharField')(default='material', max_length=12),
                      keep_default=False)


        # Changing field 'EconomicEvent.process'
        db.alter_column('valueaccounting_economicevent', 'process_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['valueaccounting.Process']))

        # Changing field 'EconomicEvent.commitment'
        db.alter_column('valueaccounting_economicevent', 'commitment_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['valueaccounting.Commitment']))

        # Changing field 'EconomicEvent.project'
        db.alter_column('valueaccounting_economicevent', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['valueaccounting.Project']))

    def backwards(self, orm):
        # Deleting field 'ResourceRelationship.materiality'
        db.delete_column('valueaccounting_resourcerelationship', 'materiality')


        # Changing field 'EconomicEvent.process'
        db.alter_column('valueaccounting_economicevent', 'process_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['valueaccounting.Process']))

        # Changing field 'EconomicEvent.commitment'
        db.alter_column('valueaccounting_economicevent', 'commitment_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['valueaccounting.Commitment']))

        # Changing field 'EconomicEvent.project'
        db.alter_column('valueaccounting_economicevent', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['valueaccounting.Project']))
