...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EconomicResourceType.substitutable'
        db.add_column('valueaccounting_economicresourcetype', 'substitutable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EconomicResourceType.substitutable'
        db.delete_column('valueaccounting_economicresourcetype', 'substitutable')
