...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExchangeTypeEventType.is_contribution'
        db.add_column('valueaccounting_exchangetypeeventtype', 'is_contribution',
        ...
        db.add_column('valueaccounting_exchangetype', 'transfer_from_agent_association_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exchange_types_from', null=True, to=orm['valueaccounting.AgentAssociationType']),
                      keep_default=False)
        ...
        db.add_column('valueaccounting_exchangetype', 'transfer_to_agent_association_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exchange_types_to', null=True, to=orm['valueaccounting.AgentAssociationType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExchangeTypeEventType.is_contribution'
        db.delete_column('valueaccounting_exchangetypeeventtype', 'is_contribution')
    ...
    models = {
        ...
        'valueaccounting.commitment': {
            ...
            'exchange_stage': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'commitments_at_exchange_stage'", 'null': 'True', 'to': "orm['valueaccounting.AgentAssociationType']"}),
        ...
        'valueaccounting.economicevent': {
            ...
            'exchange_stage': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'events_creating_exchange_stage'", 'null': 'True', 'to': "orm['valueaccounting.AgentAssociationType']"}),
        ...
        'valueaccounting.economicresource': {
            ...
            'exchange_stage': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'resources_at_exchange_stage'", 'null': 'True', 'to': "orm['valueaccounting.AgentAssociationType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'valueaccounting.exchangetypeeventtype': {
            'Meta': {'object_name': 'ExchangeTypeEventType'},
            'changed_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'exchange_type_event_types_changed'", 'null': 'True', 'to': "orm['auth.User']"}),
            'changed_date': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'exchange_type_event_types_created'", 'null': 'True', 'to': "orm['auth.User']"}),
            'created_date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'event_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'exchange_type_event_types'", 'to': "orm['valueaccounting.EventType']"}),
            'exchange_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'exchange_type_event_types'", 'to': "orm['valueaccounting.ExchangeType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_contribution': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'})
        },
