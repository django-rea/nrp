...
urlpatterns = patterns("",
    ...
    url(r"^json-project-processes/(?P<project_id>\d+)/$", 'valuenetwork.valueaccounting.views.json_project_processes', name="json_project_processes"),
    ...
    url(r"^processes-graph/(?P<project_id>\d+)/$", 'valuenetwork.valueaccounting.views.processes_graph', name="processes_graph"),
