...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProcessTypeResourceType.event_type'
        db.add_column('valueaccounting_processtyperesourcetype', 'event_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='process_resource_types', to=orm['valueaccounting.EventType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProcessTypeResourceType.event_type'
        db.delete_column('valueaccounting_processtyperesourcetype', 'event_type_id')
