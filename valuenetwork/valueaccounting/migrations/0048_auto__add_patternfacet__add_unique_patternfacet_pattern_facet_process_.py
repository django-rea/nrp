...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PatternFacet'
        db.create_table('valueaccounting_patternfacet', (
            ...
            ('facet', self.gf('django.db.models.fields.related.ForeignKey')(related_name='patterns', to=orm['valueaccounting.FacetValue'])),
            ('process_relationship', self.gf('django.db.models.fields.CharField')(max_length=12)),
        ))
        db.send_create_signal('valueaccounting', ['PatternFacet'])

        # Adding unique constraint on 'PatternFacet', fields ['pattern', 'facet', 'process_relationship']
        db.create_unique('valueaccounting_patternfacet', ['pattern_id', 'facet_id', 'process_relationship'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'PatternFacet', fields ['pattern', 'facet', 'process_relationship']
        db.delete_unique('valueaccounting_patternfacet', ['pattern_id', 'facet_id', 'process_relationship'])

        # Deleting model 'PatternFacet'
        db.delete_table('valueaccounting_patternfacet')
    ...
    models = {
        ...
        'valueaccounting.economicresourcetype': {
            'Meta': {'ordering': "('category', 'name')", 'unique_together': "(('name', 'category'),)", 'object_name': 'EconomicResourceType'},
        ...
        'valueaccounting.patternfacet': {
            'Meta': {'ordering': "('pattern', 'facet')", 'unique_together': "(('pattern', 'facet', 'process_relationship'),)", 'object_name': 'PatternFacet'},
            'facet': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'patterns'", 'to': "orm['valueaccounting.FacetValue']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
