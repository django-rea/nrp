...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming model 'PatternLoggingMethod'
        db.rename_table('valueaccounting_patternloggingmethod', 'valueaccounting_patternusecase')
        db.send_create_signal('valueaccounting', ['PatternUseCase'])

    def backwards(self, orm):
        # Renaming model 'PatternUseCase'
        db.rename_table('valueaccounting_patternusecase', 'valueaccounting_patternloggingmethod')
