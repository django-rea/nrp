...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Commitment.transfer'
        db.add_column('valueaccounting_commitment', 'transfer',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='commitments', null=True, to=orm['valueaccounting.Transfer']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('valueaccounting_commitment', 'transfer_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='commitments', null=True, to=orm['valueaccounting.TransferType'], blank=True),
                      keep_default=False)

        # Deleting field 'Commitment.transfer'
        db.delete_column('valueaccounting_commitment', 'transfer_id')
