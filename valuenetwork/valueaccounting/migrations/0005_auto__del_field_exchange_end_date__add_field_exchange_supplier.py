...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Exchange.end_date'
        db.delete_column('valueaccounting_exchange', 'end_date')

        # Adding field 'Exchange.supplier'
        db.add_column('valueaccounting_exchange', 'supplier',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exchange', null=True, to=orm['valueaccounting.EconomicAgent']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Exchange.end_date'
        db.add_column('valueaccounting_exchange', 'end_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Exchange.supplier'
        db.delete_column('valueaccounting_exchange', 'supplier_id')
