...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ValueEquationBucket.percentage'
        db.alter_column('valueaccounting_valueequationbucket', 'percentage', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'ValueEquationBucket.percentage'
        db.alter_column('valueaccounting_valueequationbucket', 'percentage', self.gf('django.db.models.fields.IntegerField')(null=True))
