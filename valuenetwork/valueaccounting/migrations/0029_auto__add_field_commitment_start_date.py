...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Commitment.start_date'
        db.add_column('valueaccounting_commitment', 'start_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Commitment.start_date'
        db.delete_column('valueaccounting_commitment', 'start_date')
