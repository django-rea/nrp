...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Process.finished'
        db.add_column('valueaccounting_process', 'finished',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Commitment.finished'
        db.add_column('valueaccounting_commitment', 'finished',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Process.finished'
        db.delete_column('valueaccounting_process', 'finished')

        # Deleting field 'Commitment.finished'
        db.delete_column('valueaccounting_commitment', 'finished')
