...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExchangeType'
        db.create_table('valueaccounting_exchangetype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sub_exchange_types', null=True, to=orm['valueaccounting.ExchangeType'])),
            ('process_pattern', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exchange_types', null=True, to=orm['valueaccounting.ProcessPattern'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exchange_types', null=True, to=orm['valueaccounting.Project'])),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exchange_types_created', null=True, to=orm['auth.User'])),
            ('changed_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exchange_types_changed', null=True, to=orm['auth.User'])),
        ...
        db.send_create_signal('valueaccounting', ['ExchangeType'])
        ...
        db.create_table('valueaccounting_exchange', (
            ...
            ('exchange_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exchanges', null=True, on_delete=models.SET_NULL, to=orm['valueaccounting.ExchangeType'])),
        ...
        # Adding field 'Commitment.exchange'
        db.add_column('valueaccounting_commitment', 'exchange',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='commitments', null=True, to=orm['valueaccounting.Exchange']),
                      keep_default=False)

        # Adding field 'EconomicEvent.exchange'
        db.add_column('valueaccounting_economicevent', 'exchange',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='events', null=True, on_delete=models.SET_NULL, to=orm['valueaccounting.Exchange']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ExchangeType'
        db.delete_table('valueaccounting_exchangetype')

        # Deleting model 'Exchange'
        db.delete_table('valueaccounting_exchange')

        # Deleting field 'Commitment.exchange'
        db.delete_column('valueaccounting_commitment', 'exchange_id')

        # Deleting field 'EconomicEvent.exchange'
        db.delete_column('valueaccounting_economicevent', 'exchange_id')
    ...
    models = {
        ...
        'valueaccounting.exchange': {
            ...
            'exchange_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'exchanges'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['valueaccounting.ExchangeType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
        ...
        'valueaccounting.exchangetype': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'sub_exchange_types'", 'null': 'True', 'to': "orm['valueaccounting.ExchangeType']"}),
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'exchange_types'", 'null': 'True', 'to': "orm['valueaccounting.Project']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
            'url': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'})
        },
