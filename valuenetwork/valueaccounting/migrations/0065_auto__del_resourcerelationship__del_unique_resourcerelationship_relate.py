...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ResourceRelationship', fields ['related_to', 'direction', 'materiality']
        db.delete_unique('valueaccounting_resourcerelationship', ['related_to', 'direction', 'materiality'])
    ...
    def backwards(self, orm):
        ...
        db.create_table('valueaccounting_resourcerelationship', (
            ('direction', self.gf('django.db.models.fields.CharField')(default='in', max_length=12)),
            ('event_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='resource_relationships', null=True, to=orm['valueaccounting.EventType'], blank=True)),
            ('related_to', self.gf('django.db.models.fields.CharField')(default='process', max_length=12)),
            ('inverse_name', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True)),
            ('unit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='relationship_units', null=True, to=orm['valueaccounting.Unit'], blank=True)),
        ...
        # Adding unique constraint on 'ResourceRelationship', fields ['related_to', 'direction', 'materiality']
        db.create_unique('valueaccounting_resourcerelationship', ['related_to', 'direction', 'materiality'])

        # Adding field 'AgentResourceType.relationship'
        db.add_column('valueaccounting_agentresourcetype', 'relationship',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='agent_resource_types', null=True, to=orm['valueaccounting.ResourceRelationship'], blank=True),
                      keep_default=False)

        # Adding field 'Feature.relationship'
        db.add_column('valueaccounting_feature', 'relationship',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='features', null=True, to=orm['valueaccounting.ResourceRelationship'], blank=True),
                      keep_default=False)

        # Adding field 'ProcessTypeResourceType.relationship'
        db.add_column('valueaccounting_processtyperesourcetype', 'relationship',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='process_resource_types', null=True, to=orm['valueaccounting.ResourceRelationship'], blank=True),
                      keep_default=False)
