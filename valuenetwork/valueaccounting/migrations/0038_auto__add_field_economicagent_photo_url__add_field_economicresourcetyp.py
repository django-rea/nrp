...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EconomicAgent.photo_url'
        db.add_column('valueaccounting_economicagent', 'photo_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'EconomicResourceType.photo_url'
        db.add_column('valueaccounting_economicresourcetype', 'photo_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'EconomicResource.photo_url'
        db.add_column('valueaccounting_economicresource', 'photo_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


        # Changing field 'EconomicResource.created_date'
        db.alter_column('valueaccounting_economicresource', 'created_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting field 'EconomicAgent.photo_url'
        db.delete_column('valueaccounting_economicagent', 'photo_url')

        # Deleting field 'EconomicResourceType.photo_url'
        db.delete_column('valueaccounting_economicresourcetype', 'photo_url')

        # Deleting field 'EconomicResource.photo_url'
        db.delete_column('valueaccounting_economicresource', 'photo_url')


        # Changing field 'EconomicResource.created_date'
        db.alter_column('valueaccounting_economicresource', 'created_date', self.gf('django.db.models.fields.DateField')())
