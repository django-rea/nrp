...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ResourceRelationship', fields ['direction', 'related_to', 'materiality']
        db.create_unique('valueaccounting_resourcerelationship', ['direction', 'related_to', 'materiality'])


    def backwards(self, orm):
        # Removing unique constraint on 'ResourceRelationship', fields ['direction', 'related_to', 'materiality']
        db.delete_unique('valueaccounting_resourcerelationship', ['direction', 'related_to', 'materiality'])
