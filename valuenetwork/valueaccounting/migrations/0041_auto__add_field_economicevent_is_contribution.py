...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EconomicEvent.is_contribution'
        db.add_column('valueaccounting_economicevent', 'is_contribution',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EconomicEvent.is_contribution'
        db.delete_column('valueaccounting_economicevent', 'is_contribution')
