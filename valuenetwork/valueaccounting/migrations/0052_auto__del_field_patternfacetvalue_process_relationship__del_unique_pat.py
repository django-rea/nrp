...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PatternFacetValue', fields ['facet_value', 'pattern', 'process_relationship']
        db.delete_unique('valueaccounting_patternfacetvalue', ['facet_value_id', 'pattern_id', 'process_relationship'])

        # Deleting field 'PatternFacetValue.process_relationship'
        db.delete_column('valueaccounting_patternfacetvalue', 'process_relationship')

        # Adding unique constraint on 'PatternFacetValue', fields ['facet_value', 'pattern', 'event_type']
        db.create_unique('valueaccounting_patternfacetvalue', ['facet_value_id', 'pattern_id', 'event_type_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PatternFacetValue', fields ['facet_value', 'pattern', 'event_type']
        db.delete_unique('valueaccounting_patternfacetvalue', ['facet_value_id', 'pattern_id', 'event_type_id'])

        # Adding field 'PatternFacetValue.process_relationship'
        db.add_column('valueaccounting_patternfacetvalue', 'process_relationship',
                      self.gf('django.db.models.fields.CharField')(default='in', max_length=12),
                      keep_default=False)

        # Adding unique constraint on 'PatternFacetValue', fields ['facet_value', 'pattern', 'process_relationship']
        db.create_unique('valueaccounting_patternfacetvalue', ['facet_value_id', 'pattern_id', 'process_relationship'])
