...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Commitment.exchange_stage'
        db.add_column('valueaccounting_commitment', 'exchange_stage',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='commitments_at_exchange_stage', null=True, to=orm['valueaccounting.AgentAssociationType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Commitment.exchange_stage'
        db.delete_column('valueaccounting_commitment', 'exchange_stage_id')
