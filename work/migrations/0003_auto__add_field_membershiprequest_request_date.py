...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MembershipRequest.request_date'
        db.add_column('work_membershiprequest', 'request_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MembershipRequest.request_date'
        db.delete_column('work_membershiprequest', 'request_date')
