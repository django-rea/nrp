...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AccountingReference'
        db.create_table('valueaccounting_accountingreference', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal('valueaccounting', ['AccountingReference'])

        # Adding field 'EconomicResourceType.inventory_rule'
        db.add_column('valueaccounting_economicresourcetype', 'inventory_rule',
                      self.gf('django.db.models.fields.CharField')(default='yes', max_length=5),
                      keep_default=False)

        # Adding field 'EconomicResourceType.accounting_reference'
        db.add_column('valueaccounting_economicresourcetype', 'accounting_reference',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='resource_types', null=True, to=orm['valueaccounting.AccountingReference']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'AccountingReference'
        db.delete_table('valueaccounting_accountingreference')

        # Deleting field 'EconomicResourceType.inventory_rule'
        db.delete_column('valueaccounting_economicresourcetype', 'inventory_rule')

        # Deleting field 'EconomicResourceType.accounting_reference'
        db.delete_column('valueaccounting_economicresourcetype', 'accounting_reference_id')
