...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EconomicEvent.is_to_distribute'
        db.add_column('valueaccounting_economicevent', 'is_to_distribute',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TransferType.is_to_distribute'
        db.add_column('valueaccounting_transfertype', 'is_to_distribute',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EconomicEvent.is_to_distribute'
        db.delete_column('valueaccounting_economicevent', 'is_to_distribute')

        # Deleting field 'TransferType.is_to_distribute'
        db.delete_column('valueaccounting_transfertype', 'is_to_distribute')
