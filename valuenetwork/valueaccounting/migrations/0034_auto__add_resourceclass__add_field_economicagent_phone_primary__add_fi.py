...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('valueaccounting_resourceclass', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('valueaccounting', ['ResourceClass'])

        # Adding field 'EconomicAgent.phone_primary'
        db.add_column('valueaccounting_economicagent', 'phone_primary',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EconomicAgent.phone_secondary'
        db.add_column('valueaccounting_economicagent', 'phone_secondary',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EconomicResourceType.resource_class'
        db.add_column('valueaccounting_economicresourcetype', 'resource_class',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='resource_types', null=True, to=orm['valueaccounting.ResourceClass']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ResourceClass'
        db.delete_table('valueaccounting_resourceclass')

        # Deleting field 'EconomicAgent.phone_primary'
        db.delete_column('valueaccounting_economicagent', 'phone_primary')

        # Deleting field 'EconomicAgent.phone_secondary'
        db.delete_column('valueaccounting_economicagent', 'phone_secondary')

        # Deleting field 'EconomicResourceType.resource_class'
        db.delete_column('valueaccounting_economicresourcetype', 'resource_class_id')
    ...
    models = {
        ...
        'valueaccounting.valueequationbucket': {
            ...
            'filter_method': ('django.db.models.fields.CharField', [], {'default': "'dates'", 'max_length': '12', 'null': 'True', 'blank': 'True'}),
