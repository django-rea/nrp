...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PatternLoggingMethod'
        db.create_table('valueaccounting_patternloggingmethod', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pattern', self.gf('django.db.models.fields.related.ForeignKey')(related_name='logging_methods', to=orm['valueaccounting.ProcessPattern'])),
            ('logging_method', self.gf('django.db.models.fields.CharField')(max_length=12)),
        ))
        db.send_create_signal('valueaccounting', ['PatternLoggingMethod'])


    def backwards(self, orm):
        # Deleting model 'PatternLoggingMethod'
        db.delete_table('valueaccounting_patternloggingmethod')
