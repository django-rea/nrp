...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'valueaccounting.cashreceiptdistribution': {
            'Meta': {'object_name': 'CashReceiptDistribution'},
            'cash_receipt': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'distributions'", 'to': "orm['valueaccounting.EconomicEvent']"}),
        ...
        'valueaccounting.economicresourcetype': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
            'subclass': ('django.db.models.fields.CharField', [], {'default': "'other'", 'max_length': '12'}),
