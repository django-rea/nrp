...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IncomeEventDistribution.distribution'
        db.alter_column('valueaccounting_incomeeventdistribution', 'distribution_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['valueaccounting.Exchange']))

    def backwards(self, orm):

        # Changing field 'IncomeEventDistribution.distribution'
        db.alter_column('valueaccounting_incomeeventdistribution', 'distribution_id', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2015, 12, 5, 0, 0), to=orm['valueaccounting.Exchange']))
