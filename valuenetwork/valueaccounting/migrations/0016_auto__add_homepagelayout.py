...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('valueaccounting_homepagelayout', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('banner', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('use_work_panel', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('work_panel_headline', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('use_needs_panel', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('needs_panel_headline', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('use_creations_panel', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('creations_panel_headline', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('panel_1', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('panel_2', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('panel_3', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('footer', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('valueaccounting', ['HomePageLayout'])


    def backwards(self, orm):
        # Deleting model 'HomePageLayout'
        db.delete_table('valueaccounting_homepagelayout')
