...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EconomicEvent.price'
        db.add_column('valueaccounting_economicevent', 'price',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EconomicEvent.price'
        db.delete_column('valueaccounting_economicevent', 'price')
